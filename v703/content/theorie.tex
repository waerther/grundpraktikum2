...
\begin{figure}[H]
    \center
    \includegraphics[width=0.7\linewidth]{pictures/Diagramm1.pdf}
...
Deshalb wird diese Zeit $T = \text{T}_\text{Tot}$ auch \textit{Totzeit} genannt.
...
\end{equation}
annähern.
Dabei sind $\text{N}_i$ die Zählraten der Impulse verschiedener Quellen.
