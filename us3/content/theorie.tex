...
\end{equation}
\begin{wrapfigure}{r}{0.4\linewidth} \label{fig:Skizze1}
    \center
    \includegraphics[width=\linewidth]{pictures/Skizze1.pdf}
    \caption{Die Doppler-Sonographie.}
\end{wrapfigure}
Von Interesse ist der Doppler-Effekt auch in Anwendungen wie der Ultraschalltechnik, dargestellt in \hyperref[eq:doppler2]{Abbildung (\ref{fig:Skizze1})}.
